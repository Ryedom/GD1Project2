...
cutThreeState.prototype.create = function() {
...
cutThreeState.prototype.update = function() {

}

cutThreeState.prototype.checkArrowVisibility = function() {
...
cutThreeState.prototype.onTap = function(eventPointer,isDoubleTap) {
    ...
    if (eventPointer.clientX < (game.scale.width / 2.0) + game.scale.margin.left && this.currentFrame > 0) {
        ...
        game.state.start("level3State", Phaser.Plugin.StateTransition.Out.SlideLeft, Phaser.Plugin.StateTransition.In.SlideLeft);
    }
    this.checkArrowVisibility();
}
